...
| `pure_dataflow_plan.md` | DECIDED 2026-09-03 (Eric), not started: the order and acceptance for the always-update select (A) → sparse delivery, no bottom value (B) → `seq` (C); the end state on one page, the decisions to pin before each step |
