...
| `do_blocks.md` | `do` blocks: sequencing across cycles — a `select` the compiler writes (steps, branches, loops, abort); proposed 2026-09-03, go/no-go = hand-lower one ceremony |
