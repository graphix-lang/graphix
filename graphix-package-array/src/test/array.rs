...
graphix_package_core::run!(array_map0, ARRAY_MAP0, |v: Result<&Value>| {
    match v {
...
graphix_package_core::run!(array_map1, ARRAY_MAP1, |v: Result<&Value>| {
    match v {
...
graphix_package_core::run!(array_map2, ARRAY_MAP2, |v: Result<&Value>| {
    match v {
        Err(_) => true,
        Ok(_) => false,
    }
...
graphix_package_core::run!(array_filter, ARRAY_FILTER, |v: Result<&Value>| {
    match v {
        Ok(Value::Array(a)) => match &a[..] {
...
graphix_package_core::run!(array_flat_map, ARRAY_FLAT_MAP, |v: Result<&Value>| {
    match v {
        Ok(Value::Array(a)) => match &a[..] {
...
graphix_package_core::run!(array_filter_map, ARRAY_FILTER_MAP, |v: Result<&Value>| {
    match v {
        Ok(Value::Array(a)) => match &a[..] {
...
graphix_package_core::run!(array_find, ARRAY_FIND, |v: Result<&Value>| {
    match v {
        Ok(Value::Array(a)) => match &a[..] {
...
graphix_package_core::run!(array_find_map, ARRAY_FIND_MAP, |v: Result<&Value>| {
    match v {
        Ok(Value::I64(2)) => true,
        _ => false,
    }
...
graphix_package_core::run!(array_iter, ARRAY_ITER, |v: Result<&Value>| {
    match v {
        Ok(Value::I64(4)) => true,
        _ => false,
    }
...
graphix_package_core::run!(array_iterq, ARRAY_ITERQ, |v: Result<&Value>| {
    match v {
        Ok(Value::I64(8)) => true,
        _ => false,
    }
...
graphix_package_core::run!(array_fold0, ARRAY_FOLD0, |v: Result<&Value>| {
    match v {
...
graphix_package_core::run!(array_fold1, ARRAY_FOLD1, |v: Result<&Value>| {
    match v {
        Err(_) => true,
        Ok(_) => false,
    }
...
graphix_package_core::run!(array_concat, ARRAY_CONCAT, |v: Result<&Value>| {
    match v {
        Ok(Value::Array(a)) => match &a[..] {
...
graphix_package_core::run!(array_push, ARRAY_PUSH, |v: Result<&Value>| {
...
graphix_package_core::run!(array_push_front, ARRAY_PUSH_FRONT, |v: Result<&Value>| {
    match v.and_then(|v| v.clone().cast_to::<[(u64, u64); 3]>()) {
        Ok([(5, 6), (1, 2), (3, 4)]) => true,
        Ok(_) | Err(_) => false,
    }
...
graphix_package_core::run!(array_window0, ARRAY_WINDOW0, |v: Result<&Value>| {
...
graphix_package_core::run!(array_window1, ARRAY_WINDOW1, |v: Result<&Value>| {
...
graphix_package_core::run!(array_window2, ARRAY_WINDOW2, |v: Result<&Value>| {
    match v.and_then(|v| v.clone().cast_to::<[(u64, u64); 3]>()) {
        Ok([(1, 2), (3, 4), (5, 6)]) => true,
        Ok(_) | Err(_) => false,
    }
...
graphix_package_core::run!(array_len, ARRAY_LEN, |v: Result<&Value>| {
    match v {
        Ok(Value::I64(6)) => true,
        _ => false,
    }
...
graphix_package_core::run!(array_flatten, ARRAY_FLATTEN, |v: Result<&Value>| {
    match v {
        Ok(Value::Array(a)) => match &a[..] {
            [Value::I64(1), Value::I64(2), Value::I64(3), Value::I64(4), Value::I64(5), Value::I64(6)] => {
                true
...
graphix_package_core::run!(array_group0, ARRAY_GROUP0, |v: Result<&Value>| {
    match v {
        Ok(Value::Array(a)) => match &a[..] {
...
graphix_package_core::run!(array_group1, ARRAY_GROUP1, |v: Result<&Value>| {
    match v {
        Ok(_) => false,
        Err(_) => true,
    }
...
graphix_package_core::run!(array_group2, ARRAY_GROUP2, |v: Result<&Value>| {
    match v {
        Ok(_) => false,
        Err(_) => true,
    }
...
graphix_package_core::run!(array_sort0, ARRAY_SORT0, |v: Result<&Value>| {
    match v {
...
graphix_package_core::run!(array_sort1, ARRAY_SORT1, |v: Result<&Value>| {
    match v {
        Ok(v) => match v.clone().cast_to::<[i64; 5]>() {
            Ok([5, 4, 3, 2, 1]) => true,
            _ => false,
...
graphix_package_core::run!(array_sort2, ARRAY_SORT2, |v: Result<&Value>| {
    match v {
...
graphix_package_core::run!(array_sort3, ARRAY_SORT3, |v: Result<&Value>| {
    match v {
        Ok(v) => match v.clone().cast_to::<[ArcStr; 9]>() {
            Ok([a0, a1, a2, a3, a4, a5, a6, a7, a8]) => {
                &*a0 == "60"
...
graphix_package_core::run!(array_enumerate, ARRAY_ENUMERATE, |v: Result<&Value>| {
    match v {
...
graphix_package_core::run!(array_zip, ARRAY_ZIP, |v: Result<&Value>| {
    match v {
        Ok(v) => match v.clone().cast_to::<[(i64, i64); 3]>() {
            Ok([(1, 1), (2, 2), (5, 3)]) => true,
            _ => false,
...
graphix_package_core::run!(array_unzip, ARRAY_UNZIP, |v: Result<&Value>| {
    match v {
