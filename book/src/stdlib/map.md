...
val change: fn(m: Map<'k, 'v>, y: 'k, z: 'v, f: fn(x: 'v) -> 'v) -> Map<'k, 'v>;

/// remove the value associated with the specified key from the map
val remove: fn(m: Map<'k, 'v>, y: 'k) -> Map<'k, 'v>;
