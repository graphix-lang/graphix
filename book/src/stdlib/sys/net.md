...
[netidx](https://github.com/estokes/netidx).
...
val write: fn(s: string, v: Any) -> Result<_, `WriteError(string)>;

/// subscribe to the specified path
val subscribe: fn(s: string) -> Result<Primitive, `SubscribeError(string)>;

/// call the specified rpc
val call: fn(s: string, a: Array<(string, Any)>) -> Result<Primitive, `RpcError(string)>;
...
val rpc: fn(
    ...
    #doc:string,
    #spec:Array<ArgSpec>,
    #f:fn(a: Array<(string, Any)>) -> Any throws 'e
...
val list: fn(?#update:Any, s: string) -> Result<Array<string>, `ListError(string)>;
...
val list_table: fn(?#update:Any, s: string) -> Result<Table, `ListError(string)>;
...
val publish: fn(?#on_write:fn(v: Any) -> _ throws 'e, s: string, v: Any) -> Result<_, `PublishError(string)> throws 'e;
```
