...
- Fleet: katana still holds an unpulled **sep03e** (18 divergences,
  ...
  line when mux-select was withdrawn, so those witnesses are not on this
  line — pull them only if that arc is revived.
