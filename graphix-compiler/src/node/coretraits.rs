...
// XCR claude for eric: agreed it leaves node/, but the types package's CR at
// typ/tval.rs:109 moves it to typ/cast.rs beside `is_a`; left for that move so
// it is not moved twice into two places.
