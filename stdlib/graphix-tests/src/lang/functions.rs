...
// A callee whose bind fails leaves the call bottom, not riding the
// previous callee's value.
const FAILED_BIND_IS_BOTTOM: &str = r#"
{
...
run!(failed_bind_is_bottom, FAILED_BIND_IS_BOTTOM, |v: Result<&Value>| {
    matches!(v, Ok(Value::I64(-1)))
}; graphix_package_core::testing::FuseExpect::None);
